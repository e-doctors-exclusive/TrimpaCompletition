      ...
      <div className="section-one">
        <div className="land-container">
          ...
          <div className="land-card">
               <img src="https://s3-alpha-sig.figma.com/img/8125/5891/ea1583d20a3fb02917ad104af6587f3e?Expires=1698019200&Signature=oYJoSEBFi-6b3a12UfTTG73EIqaIssMbnO258e~76qXs-vq4p5byGYmQigT-eL7zJiWYI9LkLEoA0chllUF8Z63NplN~F6ziuEzHANGYgQa7XCqgXDzuVFVX904qnBk1oYG~81ACMX5tOkMrivx1pYmMzaFMdcpnWBVa4iz3GCrQYcGLK2j9SvF27i0pcVukzr1t~31YT~3Jovu8xjkF~hxsWjFyn5lXfGO1FjK8j3WrXvaNQWQGfSrq3d69vYxdsNct3ILOyY5TvZARFuJUbMlsbIrxkeK~7eLPd~sWGw6a9Q-FnFyOeefaIjOdWqexseAeEIVKp4hci4MrU-6j5w__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" alt="" />
             ...
             <div className="land-card">
               <img src="https://s3-alpha-sig.figma.com/img/ca89/1425/cf94faaf7d2ea932cf5ce939144da65c?Expires=1698019200&Signature=KMmbaz7MHZA0OpSxV9zI0-VK8zqVjBR3D9Xrc-DfRWEurXLYgwcndrWb0lhdoCftXNmfz9vnfmRIS-R16miIPu9H9pQhLYAKl83Xuzt8qK4nYU6Y6XI1ZqUv7YCnxcZ0MNiMV4KMIC9hD~MNCxXxFkdGK1y~RsnBD8Ezm2JJjVE4Mtx1eZvW6KaAuMlkO~YDA125RgxjIGQhZvTYIppDjnri~ElMiCSp6psZxagcZdpHWVKC-YhmEXGrU1uC2TCb5DOHZ4ZlnZfhRgOU1mklWF0GRJMAV8uWJekrbNY~b901GKH-~gEapagaTtX8rmTt10qb9wx8BmMVnghpD0SRKg__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" alt="" />
               <div className="card-info">
                   <div className="smalltitle">
                     <div className="text-land">
