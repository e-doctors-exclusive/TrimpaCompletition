    ...
    <div className="tripma">
      <div className="plane-seat-selection">
        ...
        <img
          ...
          src="/rectangle-9.svg"
        />
        <img className="vector-icon" alt="" src="/vector-17.svg" />
        <img
        ...
        <div className="business">
          <div className="seat-row-business">
            <img className="seat-icon" alt="" src="/seat.svg" />
            <img className="seat-icon" alt="" src="/seat1.svg" />
          ...
          <div className="seat-row-business">
            <img className="seat-icon" alt="" src="/seat.svg" />
            <img className="seat-icon" alt="" src="/seat2.svg" />
            <div className="row-number">
              <div className="div">2</div>
            </div>
            <img className="seat-icon" alt="" src="/seat1.svg" />
            <img className="seat-icon" alt="" src="/seat3.svg" />
          </div>
          <div className="seat-row-business">
            <img className="seat-icon" alt="" src="/seat3.svg" />
            <img className="seat-icon" alt="" src="/seat2.svg" />
        ...
        <div className="economy">
          <div className="seat-row-exit-row">
            ...
            <img
              ...
              alt=""
              src="/18--information.svg"
            />
          </div>
          <div className="seat-row-economy">
            <img className="seat-icon20" alt="" src="/seat4.svg" />
            <img className="seat-icon20" alt="" src="/seat4.svg" />
            <img className="seat-icon20" alt="" src="/seat4.svg" />
            <div className="row-number">
              <div className="div">6</div>
            </div>
            <img className="seat-icon20" alt="" src="/seat5.svg" />
            <img className="seat-icon20" alt="" src="/seat4.svg" />
            <img className="seat-icon20" alt="" src="/seat5.svg" />
          </div>
          <div className="seat-row-economy">
